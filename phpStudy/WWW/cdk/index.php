...
<body>
  <div class="intro" style="margin-top:80px;">
  	 &nbsp;
    <div style="color:#F00" class="validator-tips"><b>CDK LouLx</b></div>
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-8 col-centered">
          <form method="post" id="register-form" autocomplete="off" action="cdks.php" class="nice-validator n-default" novalidate>
			...
			<div class="form-group">
			  <input type="text" class="form-control" id="num" name="num" placeholder="Number of generations" autocomplete="off">
            </div>
